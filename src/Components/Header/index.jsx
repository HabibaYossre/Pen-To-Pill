...
//     currentPath === path
//       ? `${isHome ? 'text-indigo-200' : 'text-black'} font-semibold`
//       : `${isHome ? 'text-white' : 'text-black'} hover:text-indigo-500`;


//   return (
//     <nav className="fixed top-0 left-0 w-full z-50 px-6 py-4  from-white to-white">
...
const Header = () => {
  ...
  return (
    <nav className="fixed top-0 left-0 w-full z-50  px-6 py-4 shadow">
      <div className="container mx-auto flex justify-between items-center">
        {/* Logo */}
      ...
      {menuOpen && (
        <div className="lg:hidden mt-4 px-6">
          <ul className="flex flex-col space-y-4 rounded shadow p-4">
